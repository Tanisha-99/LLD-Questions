...
public class Expense {
    ...
    private Expense(ExpenseBuilder builder) throws IllegalAccessException {
        this.id = builder.id;
    ...
    public static class ExpenseBuilder {
        ...
        private List<Double> splitValues; // for custom and percentage splits
        ...
        public Expense build() throws IllegalAccessException {
            if(splitStrategy == null) {
                System.out.println("Split strategy is required");
                return null;
            }
